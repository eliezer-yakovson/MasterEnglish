const fs = require('fs');
const code = `function AdminView({ overview, search, setSearch, users, systemWords, systemWordsSearch, setSystemWordsSearch, onDedup, onRefresh, onAction, onDelete, busyKey }) {
...
fs.writeFileSync('temp_admin.jsx', code);
